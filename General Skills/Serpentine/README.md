...
Obviously the flag is xored with enkidu.
...
The information necessary for compounding is also available, and the print_flag function can be called freely, so just rewrite the source and call the print_flag function.
...
This time, I rewrote it to call the print_flag function when b is input.
